...
public class FeuilleTempsEntity extends AbstractCommonEntity<Long> {
	...
	public double getMontantRevise() {
		return montantRevise;
	}

	public void setMontantRevise(double montantRevise) {
		this.montantRevise = montantRevise;
	}
